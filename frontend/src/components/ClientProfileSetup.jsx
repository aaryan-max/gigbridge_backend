...
const DONE_KEY = "client_profile_done";
...
export default function ClientProfileSetup() {
  ...
  const saveProfile = (e) => {
    ...
    localStorage.setItem("client_profile_username", form.username);
    localStorage.setItem("client_profile_location", form.location);
    localStorage.setItem("client_profile_pin", form.pin);
    localStorage.setItem("client_profile_phone", form.phone);
    localStorage.setItem("client_profile_bio", form.bio);
    localStorage.setItem("client_profile_dob", form.dob);
    // Update in-memory auth state so route guards allow onboarding immediately
